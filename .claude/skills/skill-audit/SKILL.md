---
name: skill-audit
description: Audit installed Clawdbot/MCP skills for security risks using SkillLens. Detects exfiltration, execution, persistence, privilege bypass, prompt injection, and overbroad triggers. Produces risk-scored reports with concrete evidence.
---
...
5. Evaluate risks (focus on realistic abuse)
   ...
   - **Prompt injection**: "attempts to override higher-priority instructions."
